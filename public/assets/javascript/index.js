...
$(document).ready(function() {
   //Setting a reference to the article-container div where all the dynamic content will fo
   ...
   //once the page is ready, run the initPage function to cick things off
   initPage();
   ...
   function handleArticleSave () {
      ...
      . then(function(data) {
         // If successful, monfoose will send back an object containing a key of "ok" with the value of 1
         //(which casts to 'true'
         if (data.ok) {
